...
const newsItems = [
  {
    ...
    source: '36氪',
    url: 'https://36kr.com/search/articles/AI%20Agent',
  },
  {
    date: '2026-06-01',
    tag: '市场洞察',
    ...
    source: '36氪',
    url: 'https://36kr.com/search/articles/AI%E8%90%A5%E9%94%80',
  },
  {
    date: '2026-05-15',
    tag: '行业动态',
    ...
    source: '界面新闻',
    url: 'https://www.jiemian.com/search?keyword=Perplexity',
  },
  {
    date: '2026-05-15',
    tag: '行业动态',
    ...
    source: '广告门',
    url: 'https://www.adquan.com/search?keyword=Perplexity',
  },
  {
    date: '2026-05-10',
    tag: 'GEO研究',
    ...
    source: '梅花网',
    url: 'https://www.meihua.info/search?keyword=GEO',
  },
  {
    date: '2026-05-10',
    tag: '技术前沿',
  ...
  },
  {
    ...
    source: '艾瑞咨询',
    url: 'https://www.iresearch.com.cn/search?keyword=AI%E8%90%A5%E9%94%80',
  },
  {
    date: '2026-05-05',
    tag: 'AI趋势',
    ...
    source: '梅花网',
    url: 'https://www.meihua.info/search?keyword=AI%E6%99%BA%E8%83%BD%E4%BD%93',
  },
  {
    date: '2026-04-22',
    tag: 'GEO研究',
    ...
    source: '51CTO',
    url: 'https://www.51cto.com/search?q=AI+Overview',
  },
  {
    date: '2026-04-03',
    tag: '行业动态',
    ...
    source: '人人都是产品经理',
    url: 'https://www.woshipm.com/search?keyword=GEO',
  },
];
        ...
        <div ref={listRef} className="max-w-4xl mx-auto space-y-6">
          {newsItems.map((item, index) => (
            <a
              ...
              className="block group relative bg-brand-gray4 p-6 lg:p-8 transition-all duration-400 hover:bg-brand-red/5 hover:shadow-card-hover hover:-translate-y-1 cursor-pointer no-underline"
            >
              <div className="flex flex-col sm:flex-row sm:items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="inline-flex items-center gap-1.5 text-brand-gray2 text-xs group-hover:text-brand-red transition-colors duration-300">
                      阅读原文
